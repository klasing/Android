...
public class FamilyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("daughter", "tne", R.drawable.family_daughter, R.raw.family_daughter));
        words.add(new Word("older brother", "taachi", R.drawable.family_older_brother, R.raw.family_older_brother));
        words.add(new Word("younger brother", "chalitti", R.drawable.family_younger_brother, R.raw.family_younger_brother));
        words.add(new Word("older sister", "tete", R.drawable.family_older_sister, R.raw.family_older_sister));
        words.add(new Word("younger sister", "kollite", R.drawable.family_younger_sister, R.raw.family_younger_sister));
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int position, long l) {
                ...
                //Log.v("FamilyActivity", "mMediaPlayer = newly created");
    ...
    private void releaseMediaPlayer() {
        ...
        if (mMediaPlayer != null) {
            ...
            mMediaPlayer = null;
            //Log.v("FamilyActivity", "mMediaPlayer = null");
    ...
    protected void onStop() {
        super.onStop();
        releaseMediaPlayer();
        Log.v("FamilyActivity", "onStop() releaseMediaPlayer()");
    }
